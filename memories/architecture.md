...
**Next app:** `NEXT_PUBLIC_SANITY_PROJECT_ID`, `NEXT_PUBLIC_SANITY_DATASET`, `SANITY_API_READ_TOKEN` (preview), `NEXT_PUBLIC_SITE_ENV`, `NEXT_PUBLIC_GTM_WEB_CONTAINER_ID`, `SANITY_REVALIDATE_SECRET`, `NEXT_PUBLIC_SANITY_STUDIO_URL`, `RESEND_API_KEY`, `CONTACT_FROM_EMAIL` (contact form — see `contact-form.md`)
