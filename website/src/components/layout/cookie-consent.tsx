...
export function CookieConsent() {
  ...
  useEffect(() => {
    ...
    // First visit: show banner after reading localStorage (client-only).
  ...
  return (
    <div
      ...
      className={`cookie-consent-panel fixed bottom-5 right-5 z-50 w-[min(calc(100vw-2.5rem),26rem)] rounded-lg border border-border bg-background/95 p-4 shadow-lg backdrop-blur-sm${visible ? "" : " hidden"}`}
    >
